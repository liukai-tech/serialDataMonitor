...
- name: BOARD_InitPeripherals
  UUID: cb2bac7b-147e-4fef-99ba-3e3d2120d088
...
- mode: 'interrupts'
- custom_name_enabled: 'false'
- type_id: 'flexcomm_usart_45d09cfc4c09ae2afd46dfb1038db19e'
- functional_group: 'BOARD_InitPeripherals'
...
static void FLEXCOMM0_init(void) {
  ...
  USART_EnableInterrupts(FLEXCOMM0_PERIPHERAL, kUSART_RxLevelInterruptEnable);
...
ctimer_callback_t CTIMER0_callback[] = {timer_CB};
